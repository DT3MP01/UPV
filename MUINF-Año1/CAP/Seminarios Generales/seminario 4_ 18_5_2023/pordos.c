                  ...
                  int nrhs, const mxArray *prhs[] )
{
  ...
  if(nrhs!=1) {
    ...
    mexErrMsgIdAndTxt( "MATLAB:pordos:maxlhs","Too many output arguments.");
  }
  ...
  if( !mxIsDouble(prhs[0]) || mxIsComplex(prhs[0]) || !(mrows==1 && ncols==1) ) {
    mexErrMsgIdAndTxt( "MATLAB:pordos:inputNotRealScalarDouble","Input must be a noncomplex scalar double.");
  }
