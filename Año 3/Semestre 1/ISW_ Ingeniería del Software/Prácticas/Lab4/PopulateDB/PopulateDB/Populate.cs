...
namespace PopulateDB
{
    class Populate
    {
        ...
        public Populate(bool initDatabase)
        {  //DB conexion
            ...
            //Initiate counters
                ...
                this.personCount= dal.GetAll<Person>().Count(); //ojo comprobar qué devuelve
        ...
        public Instructor InsertInstructor(CityHall cityHall)
        {
            ...
            if (personId.Length <= 8)
            {
                ...
                personId = personId + letter;//add the corresponding letter
        ...
        /// <summary>
        /// Insert a new gym in the DB associated to cityHall
        /// </summary>
