...
(defrule goal
        ...
        (pos ?x ?y box enemy $?bb shots ?z level ?l)
...
(deffunction start()
        ...
        (assert (pos 1 1 box b 3 4 b 4 3 b 11 2 enemy e 4 2 e 8 2 e 8 4 shots 2 level 0))
        (assert (ladder l 1 3 l 2 2 l 3 1 l 7 1 l 7 3 l 10 2 l 11 3))
        (assert (gap g 3 3 g 5 2 g 4 4 g 5 4 g 6 4 g 8 3))
        (assert (tam 11 4))
