...
set output "pca+knn-expDist.eps"
...
plot "pca+knn-expDist.out" u 1:2 t "L0" w lp lw 2 lt 1 ps 2.0 lc rgb "blue", 2.82 not w l lw 2 dt 3 lc rgb "red","pca+knn-expDist.out" u 1:3 t "L1" w lp lw 2 lt 1 ps 2.0 lc rgb "brown","pca+knn-expDist.out" u 1:4 t "L2" w lp lw 2 lt 1 ps 2.0 lc rgb "red","pca+knn-expDist.out" u 1:5 t "L3" w lp lw 2 lt 1 ps 2.0 lc rgb "green", 19.967 not w l lw 2 dt 3 lc rgb "blue", 3.517 not w l lw 2 dt 3 lc rgb "brown", 2.65 not w l lw 2 dt 3 lc rgb "green"
