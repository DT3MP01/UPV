...
plot "pca+knn-expW.out" u 1:2 t "Wilson" w lp lw 2 lt 1 ps 2.0 lc rgb "blue", 2.933 not w l lw 2 dt 3 lc rgb "blue","pca+knn-expW.out" u 1:3 t "L2" w lp lw 2 lt 1 ps 2.0 lc rgb "red", 2.8167 not w l lw 2 dt 3 lc rgb "red"
