 ...
 * 
 * Se pueden determinar los objetos creados consultando el 
 * atributo estatico, o variable de clase, contador, utilizando
 * el metodo numPuntos
 * 
 * @author IIP
 * @version 2016-2017
...
public class PuntoR {
    ...
    //Un PuntoR TIENE...
    private static int contador = 0; // ...UN contador de los puntos 
                                     //    creados (objetos de la clase) 
    private double x; // UNA abscisa
    private double y; // UNA ordenada
    
    /** Crea un punto (abs, ord), lo que incrementa en 1 
     *  el no de puntos (objetos de la clase) creados */
     ...
     *  lo que incrementa en 1 el no de puntos (objetos de 
     *  la clase) creados */
    ...
    /** Crea un punto estandar, i.e. el (0.0, 0.0),  
      * lo que incrementa en 1 el no de puntos creados */
    public PuntoR() { 
   ...
   /** Actualiza a nuevo el valor de la abscisa de un punto */
    ...
    public void mover(double dx, double dy) { x += dx; y += dy; }
    ...
    /** Devuelve el numero de puntos creados hasta el momento 
     *  de su invocacion */
    public static int numPuntos() { return contador; }
    ...
    // Metodos de Object que sobrescribe: equals y toString
    /** Comprueba si un punto es igual a otro, 
     *  i.e. si sus coordenadas coinciden */
