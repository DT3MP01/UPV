...
cat tr_tweets_es_clean_FEMALE.txt | ngram-count -text - -lm female_es.darpa -order 6 -write-vocab vocf_es -unk
...
cat tr_tweets_es_clean_MALE.txt | ngram-count -text - -lm male_es.darpa -order 6 -write-vocab vocm_es -unk
