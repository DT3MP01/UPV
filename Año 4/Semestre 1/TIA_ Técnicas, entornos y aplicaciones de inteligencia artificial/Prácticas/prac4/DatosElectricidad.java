...
public class DatosElectricidad {
  ...
  public static final int[] horasTramo = { 0, 4, 4, 4 };

  // potencia maxima contratada para cada tramo  (el tramo 0 es ficticio)
  public static final double[] potenciaMaximaTramo = { 0, 15, 18, 25 };

  // precio del kWh para cada tramo  (el tramo 0 es ficticio)
  public static final double[] preciokWhTramo = { 0, 0.26, 0.18, 0.13 };
}
