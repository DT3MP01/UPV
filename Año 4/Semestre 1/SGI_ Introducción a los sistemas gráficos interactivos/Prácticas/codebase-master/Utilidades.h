...
const GLfloat GRISCLARO[] = { (GLfloat) 0.7, (GLfloat) 0.7, (GLfloat) 0.7, 1 };
const GLfloat GRISOSCURO[] = { (GLfloat) 0.2, (GLfloat) 0.2, (GLfloat) 0.2, 1 };
const GLfloat ROJO[] = { 1, 0, 0, 1 };
const GLfloat VERDE[] = { 0, 1, 0,1 };
const GLfloat AZUL[] = { 0, 0, 1, 1 };
const GLfloat AMARILLO[] = { 1, 1, 0, 1 };
const GLfloat BRONCE[] = { (GLfloat) 140 / 255, (GLfloat) 120 / 255, (GLfloat) 83 / 255, 1 };
const GLfloat MARINO[] = { 0, 0, 0.5, 1 };
const GLfloat ORO[] = { (GLfloat) 218.0 / 255, (GLfloat) 165 / 255, (GLfloat) 32 / 255, 1 };
...
void loadImageFile(char* nombre)
{
	...
	FIBITMAP* imagen = FreeImage_Load(FreeImage_GetFileType(nombre, 0), nombre);
