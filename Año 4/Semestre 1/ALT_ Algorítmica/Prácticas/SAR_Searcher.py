...
if __name__ == "__main__":
    ...
    group2.add_argument('-E', '--seach', dest='search', action='store_true', default=False,
                        help='seach suggestions.')
    group2.add_argument('-D', '--distance', dest='distance', type=str, action='store', default='levenshtein',
                        help='distance to use. "levenshtein" by default.')
    ...
    # ALT EXTENSION -- Argumentos distancias
    searcher.set_search(args.search, args.distance, args.threshold)
