...
public class ChatClientCSD
    ...
    final ChatConfiguration conf;
    IChatServer srv = null;   // We just connect to one single server
    IChatUser myUser = null;  // Our own user    
 ...
 /* ACTIVITY 2. Create a local object "ChatUser" and register it in the server. 
    ...
    //
    public void doTerminate() throws RemoteException {
        doDisconnect();
        System.exit(0);
    }
