...
public class ChatUI {
    ...
    private void createUI() {
        ...
        txtMessage.addActionListener((ActionEvent e) -> {
            onMessageTyped();
        });
        ...
        txtServer.addActionListener((ActionEvent e) -> {
            onConnectionParamsChanged();
        });
        txtNick.addActionListener((ActionEvent e) -> {
            onConnectionParamsChanged();
        });

        lstChannelList.addActionListener((ActionEvent e) -> {
            onChannelSelected();
        });

        lstUserList.addActionListener((ActionEvent e) -> {
            onUserSelected();
        });
    ...
    //
    public void onConnectButtonPressed() throws RemoteException {
        if (!bConnected) {
            connect();
        } else {
            disconnect();
    ...
    //
    public void onWindowClose() throws RemoteException {
        cc.doTerminate();
    }
