...
public class GUIEditorPredictivo extends JFrame implements
    ...
    /**
     * Evento que ocurre cuando el usuario selecciona un sucesor: completa la
     * palabra actual con el sucesor seleccionado
     */
    public void seleccionarSugerencia() {
        if (listSucesores.getSelectedValue() == null) {
            return;
        }
    ...
    /**
     * Impide el movimiento del cursor de texto (siempre queda al final del
     * texto)
     *
    ...
    /**
     * Clase para impedir la introduccion de caracteres no deseados en el cuerpo
     * del mensaje
     */
    @SuppressWarnings("unchecked")
    private class LimitedStyledDocument
         ...
         * @throws javax.swing.text.BadLocationException si la posicion no es
         * valida
         */
        @Override
...
//                         }
                ...
                if (s.length() > 0) {
                    ...
                    DefaultListModel dlm = (DefaultListModel) listSucesores.getModel();
                    dlm.clear();
