...
public class TestOrdenacion {
    ...
    public static <T> int buscar(T[] v, T b, int inicio, int fin) {               
        if (inicio > fin) { 
            ...
            if (v[inicio].equals(b)) { 
                return inicio; 
            } else { 
                return buscar(v, b, inicio + 1, fin); 
            }   
        }
    }
    ...
    public static int potencia(int a, int k) {             
        if (k == 0) { 
            return 1; 
        } else {                                       
            int resLlamada = potencia(a, k - 1);     
            int resMetodo  = a * resLlamada;         
            return resMetodo;                    
        }                                           
    }
    
    static int potenciaV1(int a, int k)  {                       
        if (k == 0) { 
            return 1; 
        } else {                                                 	
            int resLlamada = potenciaV1(a, k / 2);               
            int resMetodo  = potenciaV1(a, k / 2) * resLlamada;  
            if (k % 2 != 0) { 
                resMetodo = a * resMetodo; 
            }       
            return resMetodo; 	                          
        }
    } 
